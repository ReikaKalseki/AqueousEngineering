...
namespace ReikaKalseki.AqueousEngineering {
	...
	public class ACUCallbackSystem { //TODO split into many classes
	    ...
	    private readonly Dictionary<TechType, ACUMetabolism> metabolisms = new Dictionary<TechType, ACUMetabolism>() {
			...
			{TechType.Biter, new ACUMetabolism(0.01F, 0.2F, true, RegionType.RedGrass, RegionType.Other)},
			{TechType.Blighter, new ACUMetabolism(0.005F, 0.1F, true, RegionType.BloodKelp)},
