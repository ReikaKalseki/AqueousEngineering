	...
	public static class ACUBreedHook {
		...
		static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions) {
			...
			try {
				...
				codes.Add(InstructionHandlers.createMethodCall("ReikaKalseki.AqueousEngineering.AEHooks", "tryBreedACU", false, new Type[]{typeof(WaterPark), typeof(WaterParkCreature)}));
