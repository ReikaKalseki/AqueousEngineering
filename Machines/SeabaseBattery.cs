...
namespace ReikaKalseki.AqueousEngineering {
	...
	public class BaseBattery : CustomMachine<BaseBatteryLogic> {
		...
		public override void initializeMachine(GameObject go) {
			...
			GameObject mdl = RenderUtil.setModel(go, "shelve_02", ObjectUtil.lookupPrefab("0f779340-8064-4308-8baa-6be9324a1e05").getChildObject("Starship_tech_box_01_02/Starship_tech_box_01_01"));
